...
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() throws JSONException {
        ...
        try {
            ...
            // Json string SAMPLE_JSON_STRING is converted into a json object
            JSONObject json = new JSONObject(SAMPLE_JSON_RESPONSE);

            //Extracting Features array from json string SAMPLE_JSON_REPOSNSE
            JSONArray earthquakearray= json.getJSONArray("features");
